      ...
      actions: <Widget>[
        ...
        ClipRRect(
          ...
          child: Container(
            ...
            child: Image.asset("assets/usr.png", fit: BoxFit.fill),
          ),
        ).p(8),
      ],
    );
  ...
  Widget _header() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Make Your Appointment", style: TextStyles.titleM),
      ],
    ).p16;
  }
  ...
  Widget _searchField() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: <BoxShadow>[
          BoxShadow(
            color: Colors.grey.withOpacity(.96),
            blurRadius: 15,
            offset: Offset(5, 5),
          )
        ],
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          suffixIcon: SizedBox(
            width: 50,
            child:
                Icon(Icons.search, color: Colors.red).alignCenter.ripple(
                      () {},
